    ...
    <div className="flex flex-col min-h-screen">
      <section className="py-24 md:py-32 relative overflow-hidden" style={{ background: "hsl(220,90%,8%)", color: "hsl(215,30%,93%)" }}>
        ...
        <div className="container mx-auto px-4 text-center max-w-4xl relative z-10">
          <div className="inline-block px-4 py-1 mb-8 border border-[hsl(46,98%,52%)] text-[hsl(46,98%,52%)] font-bold text-xs">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <Link href="/signup">
              <Button size="lg" className="rounded-xl h-14 px-8 text-base font-semibold w-full sm:w-auto hover:bg-primary/90" data-testid="button-hero-cta">
      ...
      <section className="py-24 bg-background">
        <div className="container mx-auto px-4">
          <div className="mb-16 text-center max-w-2xl mx-auto">
            <h2 className="text-3xl font-bold mb-4">Command Every Aspect</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="border border-border p-8 bg-card group hover:border-primary transition-colors">
              ...
              <h3 className="text-xl font-bold mb-2">Industrial Grade</h3>
      ...
      <section className="py-24 bg-card border-t border-border">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              <h2 className="text-4xl font-bold mb-6">Engineered for the Field</h2>
              ...
              <ul className="space-y-4">
                <li className="flex items-center gap-3 font-bold text-sm"><CheckCircle2 className="h-5 w-5 text-primary" /> Offline sync capabilities</li>
                <li className="flex items-center gap-3 font-bold text-sm"><CheckCircle2 className="h-5 w-5 text-primary" /> One-tap photo uploads</li>
                <li className="flex items-center gap-3 font-bold text-sm"><CheckCircle2 className="h-5 w-5 text-primary" /> Digital signature capture</li>
                <li className="flex items-center gap-3 font-bold text-sm"><CheckCircle2 className="h-5 w-5 text-primary" /> Instant parts requisition</li>
              </ul>
            </div>
            <div className="relative">
              ...
              <div className="border border-border bg-background p-8 relative z-10 shadow-2xl">
                <div className="border-b border-border pb-4 mb-4 flex justify-between items-center">
                  <div className="font-bold">Job #8492</div>
                  <div className="px-2 py-1 bg-green-500/20 text-green-700 text-xs font-bold">In Progress</div>
                </div>
  ...
  return (
    <div className="container mx-auto px-4 py-20">
      <div className="max-w-3xl mb-16">
        <h1 className="text-4xl md:text-5xl font-bold mb-6">Full Arsenal</h1>
...
export function Integrations() {
  return (
    <div className="container mx-auto px-4 py-20 text-center">
      <h1 className="text-4xl md:text-5xl font-bold mb-6">Ecosystem Integrations</h1>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-8 max-w-5xl mx-auto">
        <div className="p-12 border border-border bg-card flex flex-col items-center justify-center hover:border-primary transition-colors">
          ...
          <div className="text-xs text-muted-foreground mt-4">Accounting</div>
        </div>
        <div className="p-12 border border-border bg-card flex flex-col items-center justify-center hover:border-primary transition-colors">
        ...
        <div className="p-12 border border-border bg-card flex flex-col items-center justify-center hover:border-primary transition-colors">
          ...
          <div className="text-xs text-muted-foreground mt-4">Payments</div>
        </div>
        <div className="p-12 border border-border bg-card flex flex-col items-center justify-center hover:border-primary transition-colors">
          <CalendarCheck className="h-8 w-8 mb-2" />
          <div className="font-bold text-xl tracking-tighter">CALENDARS</div>
          <div className="text-xs text-muted-foreground mt-4">Google / MS</div>
        </div>
      </div>
    </div>
  );
...
export function Addons() {
  return (
    <div className="container mx-auto px-4 py-20">
      <div className="max-w-3xl mb-16">
        <h1 className="text-4xl md:text-5xl font-bold mb-6">Hardware Addons</h1>
      ...
      <div className="border border-primary bg-card p-0 flex flex-col md:flex-row">
        <div className="bg-primary/5 p-12 flex-1 flex flex-col justify-center border-b md:border-b-0 md:border-r border-border">
          <div className="inline-block px-3 py-1 bg-primary text-primary-foreground font-semibold text-xs mb-6 self-start">Hardware Standard</div>
          <h2 className="text-3xl font-bold mb-4">CTRLTRADEPos® Till</h2>
          ...
          <p className="text-sm font-bold text-muted-foreground">Includes touchscreen unit & receipt printer</p>
        </div>
    ...
    <div className="container mx-auto px-4 py-20 max-w-4xl">
      ...
      <div className="space-y-8">
        ...
        <div className="border border-border p-8 bg-card flex gap-6">
          ...
          <div>
            <h3 className="text-xl font-bold mb-2">Immutable Audit Logs</h3>
  ...
  return (
    <div className="container mx-auto px-4 py-20 max-w-5xl">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-16">
        <div>
          <h1 className="text-4xl font-bold mb-6">Contact Command</h1>
          ...
          <div className="space-y-6">
            <div className="flex items-center gap-4">
              ...
              <div>
                <div className="font-bold text-xs text-muted-foreground">Support</div>
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                <div className="font-bold text-xs text-muted-foreground">HQ</div>
        ...
        {submitted ? (
          ...
          <form className="space-y-5 border border-border p-8 bg-card" onSubmit={handleSubmit}>
            <h3 className="text-2xl font-bold mb-6">Direct Transmission</h3>
            <div>
