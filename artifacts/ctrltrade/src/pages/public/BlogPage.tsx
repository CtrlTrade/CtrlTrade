      ...
      <section className="py-12 bg-background border-b border-border">
        <div className="container mx-auto px-4">
          <div className="flex flex-wrap gap-2">
            <button className="px-4 py-2 bg-primary text-primary-foreground text-sm font-semibold">All</button>
            {categories.map(cat => (
              <button key={cat} className="px-4 py-2 border border-border bg-card text-sm font-medium text-muted-foreground hover:border-primary hover:text-foreground transition-colors">
                {cat}
              </button>
            ))}
          </div>
      ...
      <section className="py-16 bg-background">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
            {posts.map((post, i) => (
              <article key={i} className="border border-border bg-card hover:border-primary transition-colors group flex flex-col">
